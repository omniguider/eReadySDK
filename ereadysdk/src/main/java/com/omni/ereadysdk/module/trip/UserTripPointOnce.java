...
public class UserTripPointOnce implements Serializable {
    ...
    public static class Builder {
        ...
        private UserTripPointOnce mUserTripPoint;

        public Builder() {
            mUserTripPoint = new UserTripPointOnce();
        }
        ...
        public UserTripPointOnce build() {
